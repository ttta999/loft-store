          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#FBF9F4] rounded-xl p-4 border border-[#E8E2D5] hover:shadow-md hover:border-[#229ED9] transition-all flex flex-col items-center gap-2 group"
              >
                ...
                <span className="font-medium text-sm text-[#1B2A4A]">Telegram</span>
                <span className="text-xs text-[#8A8275]">@loft_mens_shop</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#FBF9F4] rounded-xl p-4 border border-[#E8E2D5] hover:shadow-md hover:border-[#E1306C] transition-all flex flex-col items-center gap-2 group"
              >
                ...
                <span className="font-medium text-sm text-[#1B2A4A]">Instagram</span>
                <span className="text-xs text-[#8A8275]">@loft_mens_shop</span>
              </a>
            </div>
          </div>
